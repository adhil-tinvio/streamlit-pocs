...
def run_process():
    ...
    <div style="display: flex; justify-content: center; align-items: center; height: 100%; font-size: 18px; text-align: left;">
        <div style="width: 100%;">
            ...
            <p style="margin: 2px 0;font-size: 20px; white-space: nowrap;">1. The COA external_file should have the full list of accounts you want for the organization account.</p>
            ...
            <p style="margin: 2px 0;font-size: 16px; display: inline-block">3. Code and description columns are optional, but will be mapped if available.</p>
            <p style="margin: 2px 0;font-size: 16px; display: inline-block">4. Download the organization’s Jaz COA import_file and upload both files in this tool.</p>
            <p style="margin: 2px 0;font-size: 16px; display: inline-block">5. Accounts in the external_file will be matched by AI to those in the import_file.
             If they match, duplicates will be removed.</p>
            <p style="margin: 2px 0;font-size: 16px; display: inline-block">6. Accounts in the external_file that are not matched 
            will be created as new account rows in the import template.</p>
            <p style="margin: 2px 0;font-size: 16px; display: inline-block">7. Accounts in the import_file that do not have a match on external_file 
